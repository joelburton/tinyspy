...
select is(common.wordle_colors('crane', 'crate'), 'gggxg',
  'one wrong letter → gray in place');

-- 'speed' vs 'erase' (e,r,a,s,e): no greens; s,e,e are present.
select is(common.wordle_colors('speed', 'erase'), 'yxyyx',
...
select is(common.wordle_colors('eerie', 'three'), 'yxgxg',

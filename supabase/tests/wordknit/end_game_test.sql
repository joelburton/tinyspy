-- ============================================================
-- Test: wordknit.end_game — manual "End game" terminal
-- ============================================================
--
...
select wordknit.end_game((select id from g_coop));
...
select pg_temp.as_user('ada11111-1111-1111-1111-111111111111');
select throws_ok(
  format($$ select wordknit.end_game(%L::uuid) $$, (select id from g_coop)),
  'P0001',
...
select wordknit.end_game((select id from g_compete));
...
select throws_ok(
  format($$ select wordknit.end_game(%L::uuid) $$, (select id from g_auth)),
  '42501',

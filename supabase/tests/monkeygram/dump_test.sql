...
--   1. Happy path: tiles −1 +3 (net +2); pool −3 +1; the dumped tile lands
--      at the BACK of the pool (so it can't be the tile just drawn);
--      progress.unplaced + status.pool_remaining track it
--   2. Can't dump a tile you don't hold
--   3. Can't dump when the bunch is too small (< dump_count)
--   4. Non-players rejected
-- ============================================================

 ...
 *
 * A spellingbee board must contain a pangram (a word using all 7 of its
 ...
 *
 * Loading: spellingbee.pangrams is bulk-reloaded via psql COPY
...
/** Decides whether a 7-letter mask could be a valid spellingbee puzzle
 *  seed. Mirrors `isValidPuzzleMask` in ~/spellingbee-ws/server/game.js.

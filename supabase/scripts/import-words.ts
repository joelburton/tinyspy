 ...
 *   len   root_word   definition  definition_source
 *
...
\\copy common.words (word, difficulty, american, british, canadian, australian, slur, len, root_word, definition, definition_source) from program 'gzip -dc ''${WORDS_PATH}''' with (format text, null '\\N')
commit;

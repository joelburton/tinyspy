...
| [plans/error-copy-sprint.md](plans/error-copy-sprint.md) | **THE ACTIVE SPRINT (2026-08-26)** — the error/fault redesign: `ERROR_COPY`'s shape AND the four-function API over it. The CSS sprint is paused behind it. Start at "Where to start" |

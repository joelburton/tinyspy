...
| [plans/feedback-design.md](plans/feedback-design.md) | **The feedback system's design — SHIPPED; the `feedback` area CLOSED and blessed 2026-09-12.** Every statement DECIDED; every game converted; the old system deleted. What shipped lives in `docs/ui.md → Feedback pill`, `docs/code-conventions.md → Feedback naming` and `src/common/feedback/doc.md`; this file is the reasoning archive behind them, kept until Joel says it folds |

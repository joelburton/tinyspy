...
| [plans/tab-rings.md](plans/tab-rings.md) | **Our version of tabbing** — Tab moves within a ring of stops a surface declared and never reaches the URL bar. Eight behaviors today, five of them one idea; crosswords is the only genuine exception. Designed, not built |

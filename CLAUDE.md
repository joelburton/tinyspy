...
| [plans/feedback-design.md](plans/feedback-design.md) | **The feedback system's design, and the `feedback` area's working record.** Every statement DECIDED 2026-09-12; every game converted to it the same day, and the old system deleted (its description, `feedback-system.md`, went with it). What remains here is the area's closing: the doc sweep, `feedback/doc.md`'s Design, the re-read |

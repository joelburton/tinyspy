...
| [plans/envelope-rollout.md](plans/envelope-rollout.md) | **Short-lived** — the ordering for the prep the roster needs first: reconcile the docs, shrink the over-explaining comments, the shared machinery, retro-fix the 40 already converted. Delete it when step 4 is done |

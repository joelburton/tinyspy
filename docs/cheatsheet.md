...
| `npm run waffle:generate [N]` | generate the SyrupSwap puzzle library (N per band 1–6, default 100) → committed `supabase/data/waffle-puzzles.tsv.gz`. Reads `words.tsv.gz`; no DB |

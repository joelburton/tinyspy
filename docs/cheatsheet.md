...
| "What corners did we cut" | [`deferred.md`](deferred.md) for the explicit-deferral register; per-feature "Open items" sections in `tinyspy.md`, `psychicnum.md`, `common.md` for context. |

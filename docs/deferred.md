...
The per-game table (all fourteen, ✅/❌) now leads [`pdf.md`](pdf.md#which-games-print) —
that's the one place to check or update. What's a *decision* rather than a status:

**Nothing outstanding — all fourteen games print.** waffle and wordle were a

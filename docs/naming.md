...
Examples: `tinyspy`, `psychicnum_coop`, `psychicnum_compete`, `wordknit_coop`, `wordknit_compete`, `freebee_coop`, `freebee_compete`, `monkeygram`, `waffle_coop`, `waffle_compete`.

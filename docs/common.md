...
**scrabble is the reconciliation case.** scrabble *compete* keeps its **own** seat system (`scrabble.games.current_seat` + `scrabble._advance_turn`); scrabble-*coop* turn-order uses the common pointer. Two turn mechanisms in one game is a deliberate, accepted coexistence — unifying compete onto the common primitive is out of scope.

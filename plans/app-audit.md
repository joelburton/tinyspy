...
| 47 | `pdf` | `pdf` · `shared/wordle-style/pdfTiles.ts` | printing a board — the frame, the columns, the marks, and the colored letter tiles the hidden-target games print (Joel, 2026-09-19: the tiles are printing, so they are read here). `docs/pdf.md` collapsed into the folder's `doc.md` 2026-09-19; its Setup-rows section went to `setup-form/doc.md` |
|    | **The shared families** | | |

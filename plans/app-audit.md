...
| 54 | `bee-games` | `shared/bee-games` | what spellingbee and wordwheel share and nothing else does: the hook factory, the board header it returns, the compete leaderboard row, and their board geometry. The name is KEPT (Joel, 2026-09-21, [found-words.md](found-words.md) call 5) |

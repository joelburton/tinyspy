...
| 42 | `word-list` | `word-list` | **OPEN 2026-09-20; the audit is recorded** — seven files `cs-audited-word-list`, seventeen findings in `plans/areas/word-list.md`, none worked; the prose pass is next. The alphabetical finds readout — common, not a family's: it takes its rows as a prop |

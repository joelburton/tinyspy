...
| 32 | `setup-form` | `setup-form` | **OPEN 2026-09-14.** the start-a-game dialog, its sections, and the recap rows the info column and the PDF share. With the pages because the club page is where a game starts. Thirteen findings in `plans/areas/setup-form.md`, none worked |

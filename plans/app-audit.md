...
| 35 | `board-marks` | `board-marks` | the marks a board wears for a beat, and every mark's lifetime. Renamed from `move-flash` 2026-09-16 (F-12): a move's wash is one of the things in it, and by the end of the area the newest were about a refused WORD. **Read [tile-feedback.md](tile-feedback.md) here**, not only per game — this is the mechanism that pass is about |

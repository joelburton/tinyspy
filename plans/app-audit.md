...
| 34 | `game-page` | `game-page` | **OPEN 2026-09-14.** Eleven findings in `plans/areas/game-page.md`, none worked, plus seven decisions `todo.md` handed it. the live game's page and what it hands down — `GamePage`, `gamePageCtx`, `useCommonGame`, the error boundary, the device gate, the mount points. It imports 23 folders, which is why it comes after them |

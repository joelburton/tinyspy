...
|---|---|---|---|
| **wordle** | tf1 | 2026-08-16, board marks 08-17 | first through: the in-flight dim, the verdict ring in its pill's tone, hover-as-shadow, blue history, the keyboard as a control surface. Then the four board-scope marks; the keyboard was withdrawn at terminal and now stays, disabled (2026-09-22). It went first because it needed the fewest decisions — no selection, no hint, no cursor |

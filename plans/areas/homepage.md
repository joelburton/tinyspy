...
**Status: NOT OPENED.** Audited once before the restart (2026-08-22 → 08-26) and **re-audited from scratch when it reopens**. That first audit's file was deleted 2026-09-02 (§21 → the restart): so much machinery moved underneath it that its findings described an app that no longer exists. Everything it found that pointed FORWARD survives in the plan's §7 → "Carried forward" checklist.
...
*(IDs are `F-homepage-1`, `F-homepage-2`, … — §21 → Areas. Every heading states its

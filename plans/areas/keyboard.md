...
| `useGameHasKeyboard.ts` (`isEditableField`) | the exported one, with SELECT — its own docstring says "those two are candidates to consolidate onto it". The hook moved INTO this folder from `game-page` on 2026-09-14 |

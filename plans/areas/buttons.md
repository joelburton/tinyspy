...
**`TerminalActionRow` is `info-sheet/InfoActionsRow` now** (2026-09-14, the
...
`TerminalActionRow` — `backShow`, the `show=` props, the primary variant — is
the reading that was made of it here, and stands; only the file moved.

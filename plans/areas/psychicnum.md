...
`src/psychicnum/todo.md`, not here.
...
*(agreed with Joel when the area opens — `src/psychicnum/`, its two SQL files,
and `docs/games/psychicnum.md`. List the files and STOP)*
...
`docs/games/psychicnum.md` instead; a note here never stands in for either)*
...
- [ ] `docs/games/psychicnum.md` reconciled with `todo.md`: its Deferred

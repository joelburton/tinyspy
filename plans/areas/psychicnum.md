...
that is `src/psychicnum/`, its two SQL files, and `docs/games/psychicnum.md`.)*

## Findings

*(IDs are `F-psychicnum-1`, `F-psychicnum-2`, … — §21 → Areas. Every heading states its
...
genuinely OUT of the sprint's scope goes to `docs/games/psychicnum.md` → Deferred,

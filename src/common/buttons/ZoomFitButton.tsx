 ...
 *
 * Its call site passes `show="icon"`: it floats over the board, where a word
 * has nowhere to sit, so it takes the shared square box rather than a shape of
 * its own. The label survives as the hover bubble.
 */

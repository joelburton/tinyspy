 ...
 *
 * Keyed by the word: the card takes its starting word as initial state (a
 * cross-reference inside re-points the lookup in place), so re-using the
 * instance for a new word would leave the old one on screen.
 */

...
export const FAMILIES: Family[] = [
...

  {
    ...
    formulas: {
      ...
      'primary-press': 'base −0.10 L — hover, again',
      'primary-ink': 'chosen',
      secondary: 'base −0.115 L — a big step',
      'secondary-hover': 'base 8% over the card',
      'secondary-press': 'base 16% over the card — the wash, twice',
    },
    members: [
      {
        name: 'normal',
      ...
      },
      {
        ...
        cells: [
          ...
          'var(--button-destructive-primary-press-color)',
          ...
          'var(--button-destructive-secondary-press-color)',
        ],
      },
      {
        name: 'caution',

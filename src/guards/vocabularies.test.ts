...
const VOCABULARIES: Vocabulary[] = [
  {
    ...
    pending: {
      ...
      'src/common/components/floating-panels/GameScratchpad.module.css': ['6px'],
    },
    fix:
  ...
  },
  {
    ...
    pending: {
      ...
      'src/common/components/game/CelebrationDialog.module.css': ['0.3rem', '0.4rem', '0.2rem', '1.4rem'],
      ...
      'src/common/components/floating-panels/FloatingPanel.module.css': ['0.5rem'],
      'src/common/components/floating-panels/GameScratchpad.module.css': ['0.4rem', '0.5rem'],
      'src/common/components/menu/Menu.module.css': ['1.5rem', '0.3rem', '0.1rem', '-1px', '-1rem'],
      'src/common/components/floating-panels/modalActions.module.css': ['0.75rem', '1.5rem'],
  ...
  },
  {
    ...
    pending: {
      ...
      'src/common/components/floating-panels/FloatingPanel.module.css': ['0.9rem', '1rem'],
      'src/common/components/floating-panels/GameScratchpad.module.css': ['0.85rem', '0.8rem', '0.9rem', 'max(16px,', '1em)'],
  ...
  },
  {
    ...
    pending: {
      ...
      'src/common/components/floating-panels/FloatingPanel.module.css': ['1'],
      'src/common/components/floating-panels/GameScratchpad.module.css': ['1.5'],
  ...
  },
  {
    ...
    pending: {
      ...
      'src/common/components/floating-panels/FloatingPanel.module.css': ['1px'],
      'src/common/components/floating-panels/GameScratchpad.module.css': ['1px'],

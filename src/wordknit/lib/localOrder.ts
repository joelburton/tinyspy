 ...
 *
 * The board's tile order from `wordknit.games.board.tileOrder`
 ...
 *     it — wordknit never adds tiles mid-game, but the
...
export function reconcileLocalOrder(
  ...
  // never-yet-seen case in wordknit's tile-only-removed model),

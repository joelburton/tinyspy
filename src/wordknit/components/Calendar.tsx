 ...
 * bucket lives in `SetupForm` (where we know wordknit's
...
/**
 * Month-grid calendar widget for the wordknit setup form.
 *
 ...
 * `wordknit.puzzles.nyt_date::text`). All Date construction

...
/**
 * spellingbee's play surface, shared by the coop and compete manifests. It
 * holds no board and draws no control: `<BoardCol>` owns the hive, the word
...
export function PlayArea(props: PlayAreaProps) {
  ...
  // Mobile (docs/mobile.md): below the breakpoint the hive fills the screen and
